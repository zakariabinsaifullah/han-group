...
add_action( 'enqueue_block_editor_assets', 'hang_enqueue_hover_color_editor_assets' );


if ( ! function_exists( 'hang_enqueue_hover_color_frontend_assets' ) ) :
	/**
	 * Enqueues the hover-color extension frontend stylesheet.
	 * Runs on `enqueue_block_assets` (editor + front end).
	 */
	function hang_enqueue_hover_color_frontend_assets() {
		$asset_file  = get_theme_file_path( 'build/extensions/hover-color/index.asset.php' );
		...
		wp_enqueue_style(
			'hang-hover-color-extension-style',
...
add_action( 'enqueue_block_assets', 'hang_enqueue_hover_color_frontend_assets' );


if ( ! function_exists( 'hang_render_hover_color_attributes' ) ) :
	/**
	 ...
	 */
	function hang_render_hover_color_attributes( $block_content, $block ) {
...
add_filter( 'render_block', 'hang_render_hover_color_attributes', 10, 2 );
...
if ( ! function_exists( 'hang_enqueue_group_full_height_editor_assets' ) ) :
	/**
	 * Enqueues the group-full-height extension script and editor stylesheet.
	 * Runs on `enqueue_block_editor_assets` (editor only).
	 */
	function hang_enqueue_group_full_height_editor_assets() {
		...
		wp_enqueue_script(
			'hang-group-full-height-extension',
...
add_action( 'enqueue_block_editor_assets', 'hang_enqueue_group_full_height_editor_assets' );


if ( ! function_exists( 'hang_enqueue_group_full_height_frontend_assets' ) ) :
	/**
	 * Enqueues the group-full-height frontend stylesheet.
	 * Runs on `enqueue_block_assets` (editor + front end).
	 */
	function hang_enqueue_group_full_height_frontend_assets() {
		$asset_file = get_theme_file_path( 'build/extensions/group-full-height/index.asset.php' );
		...
		wp_enqueue_style(
			'hang-group-full-height-extension-style',
...
add_action( 'enqueue_block_assets', 'hang_enqueue_group_full_height_frontend_assets' );


if ( ! function_exists( 'hang_render_group_full_height' ) ) :
	/**
	 ...
	 * @return string Modified block HTML.
	 */
	function hang_render_group_full_height( $block_content, $block ) {
...
add_filter( 'render_block', 'hang_render_group_full_height', 10, 2 );

// =============================================================================
// Group – Overlay Background Extension
// =============================================================================

if ( ! function_exists( 'hang_enqueue_group_overlay_bg_editor_assets' ) ) :
	/**
	 * Enqueues the group-overlay-bg extension script and editor stylesheet.
	 * Runs on `enqueue_block_editor_assets` (editor only).
	 */
	function hang_enqueue_group_overlay_bg_editor_assets() {
		...
		wp_enqueue_script(
			'hang-group-overlay-bg-extension',
...
add_action( 'enqueue_block_editor_assets', 'hang_enqueue_group_overlay_bg_editor_assets' );


if ( ! function_exists( 'hang_enqueue_group_overlay_bg_frontend_assets' ) ) :
	/**
	 * Enqueues the group-overlay-bg frontend stylesheet.
	 * Runs on `enqueue_block_assets` (editor + front end).
	 */
	function hang_enqueue_group_overlay_bg_frontend_assets() {
		$asset_file = get_theme_file_path( 'build/extensions/group-overlay-bg/index.asset.php' );
		...
		wp_enqueue_style(
			'hang-group-overlay-bg-extension-style',
...
add_action( 'enqueue_block_assets', 'hang_enqueue_group_overlay_bg_frontend_assets' );


if ( ! function_exists( 'hang_render_group_overlay_bg' ) ) :
	/**
	 * Injects the `hang-overlay-bg` class and `--hang-overlay-bg` CSS custom property
	 ...
	 * @return string Modified block HTML.
	 */
	function hang_render_group_overlay_bg( $block_content, $block ) {
		if ( 'core/group' !== $block['blockName'] ) {
			return $block_content;
		}
		...
		$processor = new WP_HTML_Tag_Processor( $block_content );
		if ( $processor->next_tag() ) {
			$processor->add_class( 'hang-overlay-bg' );
			...
			$new_style .= '--hang-overlay-bg:' . $bg_value;
			$processor->set_attribute( 'style', $new_style );
...
add_filter( 'render_block', 'hang_render_group_overlay_bg', 10, 2 );
...
if ( ! function_exists( 'hang_enqueue_group_global_hover_editor_assets' ) ) :
	/**
	 * Enqueues the group-global-hover extension script and editor stylesheet.
	 * Runs on `enqueue_block_editor_assets` (editor only).
	 */
	function hang_enqueue_group_global_hover_editor_assets() {
		...
		wp_enqueue_script(
			'hang-group-global-hover-extension',
...
add_action( 'enqueue_block_editor_assets', 'hang_enqueue_group_global_hover_editor_assets' );


if ( ! function_exists( 'hang_enqueue_group_global_hover_frontend_assets' ) ) :
	/**
	 * Enqueues the group-global-hover frontend stylesheet.
	 * Runs on `enqueue_block_assets` (editor + front end).
	 */
	function hang_enqueue_group_global_hover_frontend_assets() {
		$asset_file = get_theme_file_path( 'build/extensions/group-global-hover/index.asset.php' );
		...
		wp_enqueue_style(
			'hang-group-global-hover-extension-style',
...
add_action( 'enqueue_block_assets', 'hang_enqueue_group_global_hover_frontend_assets' );


if ( ! function_exists( 'hang_render_group_global_hover' ) ) :
	/**
	 * Injects `hang-global-hover` class + CSS variables into core/group blocks on the
	 ...
	 * @return string Modified block HTML.
	 */
	function hang_render_group_global_hover( $block_content, $block ) {
		if ( 'core/group' !== $block['blockName'] ) {
			return $block_content;
		}
		...
		if ( $has_bg ) {
			$css_vars[] = '--hang-ghover-bg:' . ( $bg_color ? 'var(--wp--preset--color--' . $bg_color . ')' : $custom_bg_color );
		}

		if ( $has_color ) {
			$css_vars[] = '--hang-ghover-color:' . ( $color ? 'var(--wp--preset--color--' . $color . ')' : $custom_color );
		}

		$processor = new WP_HTML_Tag_Processor( $block_content );
		if ( $processor->next_tag() ) {
			$processor->add_class( 'hang-global-hover' );
...
add_filter( 'render_block', 'hang_render_group_global_hover', 10, 2 );

// =============================================================================
// Heading & Paragraph – Max Width Extension
// =============================================================================

if ( ! function_exists( 'hang_enqueue_text_max_width_editor_assets' ) ) :
	/**
	 * Enqueues the text-max-width extension script and editor stylesheet.
	 * Runs on `enqueue_block_editor_assets` (editor only).
	 */
	function hang_enqueue_text_max_width_editor_assets() {
...
add_action( 'enqueue_block_editor_assets', 'hang_enqueue_text_max_width_editor_assets' );


if ( ! function_exists( 'hang_enqueue_text_max_width_frontend_assets' ) ) :
	/**
	 * Enqueues the text-max-width frontend stylesheet.
	 * Runs on `enqueue_block_assets` (editor + front end).
	 */
	function hang_enqueue_text_max_width_frontend_assets() {
		$asset_file = get_theme_file_path( 'build/extensions/text-max-width/index.asset.php' );
		...
		wp_enqueue_style(
			'hang-text-max-width-extension-style',
...
add_action( 'enqueue_block_assets', 'hang_enqueue_text_max_width_frontend_assets' );


if ( ! function_exists( 'hang_render_text_max_width' ) ) :
	/**
	 ...
	 * @return string Modified block HTML.
	 */
	function hang_render_text_max_width( $block_content, $block ) {
...
add_filter( 'render_block', 'hang_render_text_max_width', 10, 2 );
...
if ( ! function_exists( 'hang_enqueue_text_responsive_align_editor_assets' ) ) :
	/**
	 * Enqueues the text-responsive-align extension script and editor stylesheet.
	 * Runs on `enqueue_block_editor_assets` (editor only).
	 */
	function hang_enqueue_text_responsive_align_editor_assets() {
		...
		wp_enqueue_script(
			'hang-text-responsive-align-extension',
...
add_action( 'enqueue_block_editor_assets', 'hang_enqueue_text_responsive_align_editor_assets' );


if ( ! function_exists( 'hang_enqueue_text_responsive_align_frontend_assets' ) ) :
	/**
	 * Enqueues the text-responsive-align frontend stylesheet.
	 * Runs on `enqueue_block_assets` (editor + front end).
	 */
	function hang_enqueue_text_responsive_align_frontend_assets() {
		$asset_file = get_theme_file_path( 'build/extensions/text-responsive-align/index.asset.php' );
		...
		wp_enqueue_style(
			'hang-text-responsive-align-extension-style',
...
add_action( 'enqueue_block_assets', 'hang_enqueue_text_responsive_align_frontend_assets' );


if ( ! function_exists( 'hang_render_text_responsive_align' ) ) :
	/**
	 ...
	 * @return string Modified block HTML.
	 */
	function hang_render_text_responsive_align( $block_content, $block ) {
		$supported = array( 'core/heading', 'core/paragraph' );
...
add_filter( 'render_block', 'hang_render_text_responsive_align', 10, 2 );
...
if ( ! function_exists( 'hang_enqueue_button_full_width_mobile_editor_assets' ) ) :
	/**
	 * Enqueues the button-full-width-mobile extension script and editor stylesheet.
	 * Runs on `enqueue_block_editor_assets` (editor only).
	 */
	function hang_enqueue_button_full_width_mobile_editor_assets() {
		...
		wp_enqueue_script(
			'hang-button-full-width-mobile-extension',
...
add_action( 'enqueue_block_editor_assets', 'hang_enqueue_button_full_width_mobile_editor_assets' );


if ( ! function_exists( 'hang_enqueue_button_full_width_mobile_frontend_assets' ) ) :
	/**
	 * Enqueues the button-full-width-mobile frontend stylesheet.
	 * Runs on `enqueue_block_assets` (editor + front end).
	 */
	function hang_enqueue_button_full_width_mobile_frontend_assets() {
		$asset_file = get_theme_file_path( 'build/extensions/button-full-width-mobile/index.asset.php' );
		...
		wp_enqueue_style(
			'hang-button-full-width-mobile-extension-style',
...
add_action( 'enqueue_block_assets', 'hang_enqueue_button_full_width_mobile_frontend_assets' );


if ( ! function_exists( 'hang_render_button_full_width_mobile' ) ) :
	/**
	 ...
	 * @return string Modified block HTML.
	 */
	function hang_render_button_full_width_mobile( $block_content, $block ) {
...
add_filter( 'render_block', 'hang_render_button_full_width_mobile', 10, 2 );

// =============================================================================
// Button – Iconic Button Extension
// =============================================================================

if ( ! function_exists( 'hang_enqueue_iconic_button_editor_assets' ) ) :
	/**
	 * Enqueues the iconic-button extension script and editor stylesheet.
	 * Runs on `enqueue_block_editor_assets` (editor only).
	 */
	function hang_enqueue_iconic_button_editor_assets() {
...
add_action( 'enqueue_block_editor_assets', 'hang_enqueue_iconic_button_editor_assets' );


if ( ! function_exists( 'hang_enqueue_iconic_button_frontend_assets' ) ) :
	/**
	 * Enqueues the iconic-button extension frontend stylesheet.
	 * Runs on `enqueue_block_assets` (editor + front end).
	 */
	function hang_enqueue_iconic_button_frontend_assets() {
		$asset_file = get_theme_file_path( 'build/extensions/iconic-button/index.asset.php' );
		...
		wp_enqueue_style(
			'hang-iconic-button-extension-style',
...
add_action( 'enqueue_block_assets', 'hang_enqueue_iconic_button_frontend_assets' );


if ( ! function_exists( 'hang_iconic_button_svg_kses_args' ) ) :
	/**
	 * Allowed SVG tags/attributes for icons rendered inside the iconic-button markup.
	 *
	 * @return array Kses args for wp_kses().
	 */
	function hang_iconic_button_svg_kses_args() {
...
if ( ! function_exists( 'hang_render_iconic_button' ) ) :
	/**
	 ...
	 * @return string Modified block HTML.
	 */
	function hang_render_iconic_button( $block_content, $block ) {
		if ( 'core/button' !== ( $block['blockName'] ?? '' ) ) {
			return $block_content;
		}
		...
		if ( ! empty( $attrs['iconicButtonIconSize'] ) ) {
			$css_vars[] = '--hang-icon-size:' . esc_attr( $attrs['iconicButtonIconSize'] );
		}
		if ( ! empty( $attrs['iconicButtonIconGap'] ) ) {
			$css_vars[] = '--hang-icon-gap:' . esc_attr( $attrs['iconicButtonIconGap'] );
		}
		if ( ! empty( $attrs['iconicButtonIconPadding'] ) ) {
			$css_vars[] = '--hang-icon-padding:' . esc_attr( $attrs['iconicButtonIconPadding'] );
		}
		if ( ! empty( $attrs['iconicButtonIconBgColor'] ) ) {
			$css_vars[] = '--hang-icon-bg-color:' . esc_attr( $attrs['iconicButtonIconBgColor'] );
		}
		...
		// on the .hang-icon-before class), so the DOM position is always icon-after-text.
		$icon_html = '<span class="hang-icon-button-svg">' . wp_kses( $icon_svg, hang_iconic_button_svg_kses_args() ) . '</span>';
...
add_filter( 'render_block', 'hang_render_iconic_button', 10, 2 );

// =============================================================================
// Kadence RowLayout — Featured Image as Background Extension
// =============================================================================

if ( ! function_exists( 'hang_enqueue_kadence_featured_bg_editor_assets' ) ) :
	/**
	 * Enqueues the kadence-featured-bg extension script and editor stylesheet.
	 */
	function hang_enqueue_kadence_featured_bg_editor_assets() {
		...
		wp_enqueue_script(
			'hang-kadence-featured-bg-extension',
...
add_action( 'enqueue_block_editor_assets', 'hang_enqueue_kadence_featured_bg_editor_assets' );


if ( ! function_exists( 'hang_enqueue_kadence_featured_bg_frontend_assets' ) ) :
	/**
	 * Enqueues the kadence-featured-bg frontend stylesheet.
	 */
	function hang_enqueue_kadence_featured_bg_frontend_assets() {
		$asset_file = get_theme_file_path( 'build/extensions/kadence-featured-bg/index.asset.php' );
		...
		wp_enqueue_style(
			'hang-kadence-featured-bg-extension-style',
...
add_action( 'enqueue_block_assets', 'hang_enqueue_kadence_featured_bg_frontend_assets' );


if ( ! function_exists( 'hang_render_kadence_featured_bg' ) ) :
	/**
	 ...
	 * @return string Modified block HTML.
	 */
	function hang_render_kadence_featured_bg( $block_content, $block ) {
		...
		if ( $processor->next_tag() ) {
			...
			$new_style .= '--hang-featured-bg-image:url(' . esc_url( $image_url ) . ')';
			$processor->set_attribute( 'style', $new_style );
...
add_filter( 'render_block', 'hang_render_kadence_featured_bg', 10, 2 );

// =============================================================================
// Kadence Column — Global Hover Effect Extension
// =============================================================================

if ( ! function_exists( 'hang_enqueue_kadence_global_hover_editor_assets' ) ) :
	/**
	 * Enqueues the kadence-global-hover extension script and editor stylesheet.
	 */
	function hang_enqueue_kadence_global_hover_editor_assets() {
		...
		wp_enqueue_script(
			'hang-kadence-global-hover-extension',
...
add_action( 'enqueue_block_editor_assets', 'hang_enqueue_kadence_global_hover_editor_assets' );


if ( ! function_exists( 'hang_enqueue_kadence_global_hover_frontend_assets' ) ) :
	/**
	 * Enqueues the kadence-global-hover frontend stylesheet.
	 */
	function hang_enqueue_kadence_global_hover_frontend_assets() {
		$asset_file = get_theme_file_path( 'build/extensions/kadence-global-hover/index.asset.php' );
		...
		wp_enqueue_style(
			'hang-kadence-global-hover-extension-style',
...
add_action( 'enqueue_block_assets', 'hang_enqueue_kadence_global_hover_frontend_assets' );


if ( ! function_exists( 'hang_render_kadence_global_hover' ) ) :
	/**
	 ...
	 * @return string Modified block HTML.
	 */
	function hang_render_kadence_global_hover( $block_content, $block ) {
...
add_filter( 'render_block', 'hang_render_kadence_global_hover', 10, 2 );
...
if ( ! function_exists( 'hang_enqueue_highlight_editor_assets' ) ) :
	/**
	 * Enqueues the highlight format script and editor stylesheet.
	 * Runs on `enqueue_block_editor_assets` (editor only).
	 */
	function hang_enqueue_highlight_editor_assets() {
...
add_action( 'enqueue_block_editor_assets', 'hang_enqueue_highlight_editor_assets' );


if ( ! function_exists( 'hang_enqueue_highlight_frontend_assets' ) ) :
	/**
	 * Enqueues the highlight format stylesheet.
	 * Runs on `enqueue_block_assets` (editor + front end).
	 */
	function hang_enqueue_highlight_frontend_assets() {
		$asset_file = get_theme_file_path( 'build/extensions/highlight/index.asset.php' );
		...
		wp_enqueue_style(
			'hang-highlight-extension-style',
...
add_action( 'enqueue_block_assets', 'hang_enqueue_highlight_frontend_assets' );
