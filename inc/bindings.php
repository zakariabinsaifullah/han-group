...
if ( ! function_exists( 'hang_register_block_bindings' ) ) :
	/**
	 ...
	 */
	function hang_register_block_bindings() {
		register_block_bindings_source(
			...
			array(
				...
				'get_value_callback' => 'hang_format_binding',
			)
		);
	}
endif;
add_action( 'init', 'hang_register_block_bindings' );


if ( ! function_exists( 'hang_format_binding' ) ) :
	/**
