    ...
    return props => {
        ...
        return (
            <>
                ...
                { isSelected && (
                    <InspectorControls>
                        <PanelBody title={ __( 'Icon Settings', 'han-group' ) } initialOpen={ initialOpen }>
                            <NativeToggleControl
                                label={ __( 'Add Icon to Button', 'han-group' ) }
                                ...
                                onChange={ () => {
                                    ...
                                    if ( newEnabled && ! iconicButtonUniqueClass ) {
                                        newAttrs.iconicButtonUniqueClass = `hang-icon-button-${ clientId.slice( 0, 8 ) }`;
                                    }
                            ...
                            { iconicButtonEnabled && (
                                <>
                                    ...
                                    <NativeToggleGroupControl
                                        label={ __( 'Position', 'han-group' ) }
                                        value={ iconicButtonIconPosition }
                                        options={ [
                                            { label: __( 'Before', 'han-group' ), value: 'hang-icon-before' },
                                            { label: __( 'After', 'han-group' ), value: '' }
                                        ] }
...
addFilter( 'editor.BlockEdit', 'hang/iconic-button-panel', hangIconicButtonPanel );
