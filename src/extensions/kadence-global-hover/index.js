 ...
 */
addFilter('blocks.registerBlockType', 'hang/kadence-global-hover-add-attribute', (settings, name) => {
    if (name !== BLOCK_NAME) {
        return settings;
    }
...
addFilter(
    'editor.BlockEdit',
    'hang/kadence-global-hover-add-inspector-controls',
            ...
            return (
                <>
                    ...
                    <InspectorAdvancedControls>
                        <NativeToggleControl
                            label={__('Enable Hover Gradient Border', 'han-group')}
...
addFilter(
    ...
    'hang/kadence-global-hover-add-class',
